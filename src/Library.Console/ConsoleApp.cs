...
public class ConsoleApp
{
    ...
    async Task<ConsoleState> SearchBooks()
    {
        ...
        foreach (var bookItem in bookItems)
        {
            ...
            {
                if (soonestDue == null || loan.DueDate < soonestDue)
                    soonestDue = loan.DueDate;
            }
        }
        ...
        {
            Console.WriteLine($"{book.Title} is on loan to another patron. The return due date is {soonestDue}");
        }
